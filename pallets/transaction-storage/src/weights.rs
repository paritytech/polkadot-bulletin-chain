...
//!
//! `store_with_cid_config` numbers were generated locally (frame-omni-bencher,
//! 2026-07-22) and should be regenerated by the bench bot.
//!
//! Authorization and authorizer weights (`authorize_*`, `refresh_*`, `*_authorizer`,
//! `remove_expired_*`) were refreshed from the 2026-09-25 bulletin-paseo run.
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn store_with_cid_config(l: u32, ) -> Weight {
		...
		Weight::from_parts(32_860_948, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 15
			.saturating_add(Weight::from_parts(3_992, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
