...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		...
		#[pallet::feeless_if(|_origin: &OriginFor<T>, _who: &T::AccountId, _transactions: &u32, _bytes: &u64| -> bool { true })]
		...
		#[pallet::feeless_if(|_origin: &OriginFor<T>, _content_hash: &ContentHash, _max_size: &u64| -> bool { true })]
