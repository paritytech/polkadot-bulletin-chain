...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		Weight::from_parts(20_490_000, 0)
			...
			// Standard Error: 11
			.saturating_add(Weight::from_parts(7_693, 0).saturating_mul(l.into()))
	...
	fn validate_store(l: u32, ) -> Weight {
		...
		Weight::from_parts(32_143_827, 0)
			.saturating_add(Weight::from_parts(0, 42959))
			// Standard Error: 1
			.saturating_add(Weight::from_parts(3_061, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: `TransactionStorage::Transactions` (r:1 w:0)
	...
	fn apply_block_inherents(n: u32, ) -> Weight {
		...
		Weight::from_parts(81_790_000, 0)
			.saturating_add(Weight::from_parts(0, 75727))
			// Standard Error: 12_685
			.saturating_add(Weight::from_parts(13_234_502, 0).saturating_mul(n.into()))
	...
	fn on_initialize_with_expiry(n: u32, ) -> Weight {
		...
		Weight::from_parts(9_270_000, 0)
			...
			.saturating_add(Weight::from_parts(12_547_694, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(4))
