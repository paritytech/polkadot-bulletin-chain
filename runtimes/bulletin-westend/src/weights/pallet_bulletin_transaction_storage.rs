...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_890_000, 0)
			...
			// Standard Error: 12
			.saturating_add(Weight::from_parts(7_858, 0).saturating_mul(l.into()))
	...
	fn check_proof() -> Weight {
		...
		//  Measured:  `41707`
		//  Estimated: `44959`
		// Minimum execution time: 81_550_000 picoseconds.
		Weight::from_parts(110_160_000, 0)
			.saturating_add(Weight::from_parts(0, 44959))
	...
	fn validate_store(l: u32, ) -> Weight {
		...
		Weight::from_parts(34_175_885, 0)
			.saturating_add(Weight::from_parts(0, 42959))
			// Standard Error: 1
			.saturating_add(Weight::from_parts(3_063, 0).saturating_mul(l.into()))
