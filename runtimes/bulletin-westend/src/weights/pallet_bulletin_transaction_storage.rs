...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_537_000, 0)
			...
			// Standard Error: 17
			.saturating_add(Weight::from_parts(6_806, 0).saturating_mul(l.into()))
	...
	fn remove_authorizer() -> Weight {
		...
		Weight::from_parts(18_702_000, 0)
			.saturating_add(Weight::from_parts(0, 3532))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn validate_store(l: u32, ) -> Weight {
		...
		Weight::from_parts(21_383_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 16
			.saturating_add(Weight::from_parts(2_872, 0).saturating_mul(l.into()))
	...
	fn apply_block_inherents(_n: u32, ) -> Weight {
		...
		Weight::from_parts(76_836_669, 0)
	...
	fn on_initialize_with_expiry(n: u32, ) -> Weight {
		...
		Weight::from_parts(7_855_000, 0)
			...
			.saturating_add(Weight::from_parts(8_177_618, 0).saturating_mul(n.into()))
	...
	fn migrate_v2_to_v3_step() -> Weight {
		...
		//  Measured:  `41812`
		//  Estimated: `94048`
		// Minimum execution time: 138_246_000 picoseconds.
		Weight::from_parts(144_883_000, 0)
