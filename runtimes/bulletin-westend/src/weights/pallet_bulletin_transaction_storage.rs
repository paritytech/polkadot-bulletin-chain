...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store_with_cid_config(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_023_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 10
			.saturating_add(Weight::from_parts(6_240, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn remove_expired_preimage_authorization() -> Weight {
		...
		Weight::from_parts(15_103_000, 0)
			.saturating_add(Weight::from_parts(0, 3550))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn remove_exhausted_authorizer() -> Weight {
		...
		//  Measured:  `330`
		//  Estimated: `3532`
		// Minimum execution time: 21_774_000 picoseconds.
	...
	fn on_initialize_with_expiry(n: u32, ) -> Weight {
		...
		Weight::from_parts(6_511_000, 0)
			...
			.saturating_add(Weight::from_parts(10_793_089, 0).saturating_mul(n.into()))
	...
	fn migrate_v2_to_v3_step() -> Weight {
		...
		//  Measured:  `41812`
		//  Estimated: `94048`
		// Minimum execution time: 136_510_000 picoseconds.
		Weight::from_parts(142_674_000, 0)
