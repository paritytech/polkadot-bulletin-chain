...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store_with_cid_config(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_344_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 13
			.saturating_add(Weight::from_parts(7_113, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn remove_exhausted_authorizer() -> Weight {
		...
		Weight::from_parts(24_968_000, 0)
			.saturating_add(Weight::from_parts(0, 3532))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn validate_store(l: u32, ) -> Weight {
		...
		Weight::from_parts(20_270_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 21
			.saturating_add(Weight::from_parts(3_110, 0).saturating_mul(l.into()))
	...
	fn apply_block_inherents() -> Weight {
		...
		//  Measured:  `44334`
		//  Estimated: `47519`
		// Minimum execution time: 77_253_000 picoseconds.
		Weight::from_parts(86_449_000, 0)
	...
	fn on_initialize_with_expiry(n: u32, ) -> Weight {
		...
		Weight::from_parts(6_444_000, 0)
			...
			.saturating_add(Weight::from_parts(11_764_139, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(4))
	...
	fn migrate_v2_to_v3_step() -> Weight {
		...
		Weight::from_parts(145_331_000, 0)
