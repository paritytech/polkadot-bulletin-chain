...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_771_000, 0)
			...
			// Standard Error: 8
			.saturating_add(Weight::from_parts(6_274, 0).saturating_mul(l.into()))
	...
	fn store_with_cid_config(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_591_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 8
			.saturating_add(Weight::from_parts(6_245, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn validate_store(l: u32, ) -> Weight {
		...
		Weight::from_parts(20_376_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 8
	...
	fn on_initialize_with_expiry(n: u32, ) -> Weight {
		...
		Weight::from_parts(6_442_000, 0)
			...
			.saturating_add(Weight::from_parts(10_916_516, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(4))
	...
	fn migrate_v2_to_v3_step() -> Weight {
		...
		//  Measured:  `41812`
		//  Estimated: `94048`
		// Minimum execution time: 138_150_000 picoseconds.
		Weight::from_parts(143_776_000, 0)
