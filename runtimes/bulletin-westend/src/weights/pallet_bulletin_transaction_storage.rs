...
//! HOSTNAME: `d66108137183`, CPU: `Intel(R) Xeon(R) CPU @ 2.60GHz`
...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_834_000, 0)
			...
			// Standard Error: 15
			.saturating_add(Weight::from_parts(6_947, 0).saturating_mul(l.into()))
	...
	fn validate_store(l: u32, ) -> Weight {
		...
		Weight::from_parts(21_352_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 14
			.saturating_add(Weight::from_parts(2_794, 0).saturating_mul(l.into()))
	...
	fn enable_auto_renew() -> Weight {
		...
		Weight::from_parts(39_406_000, 0)
			.saturating_add(Weight::from_parts(0, 47519))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn apply_block_inherents(n: u32, ) -> Weight {
		...
		Weight::from_parts(75_024_000, 0)
			.saturating_add(Weight::from_parts(0, 78287))
			// Standard Error: 17_961
			.saturating_add(Weight::from_parts(15_159_685, 0).saturating_mul(n.into()))
	...
	fn on_initialize_with_expiry(n: u32, ) -> Weight {
		...
		Weight::from_parts(7_916_000, 0)
			.saturating_add(Weight::from_parts(0, 78287))
			// Standard Error: 15_532
			.saturating_add(Weight::from_parts(11_508_792, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(5))
	...
	fn migrate_v2_to_v3_step() -> Weight {
		...
		//  Measured:  `41726`
		//  Estimated: `94048`
		// Minimum execution time: 131_493_000 picoseconds.
		Weight::from_parts(140_844_000, 0)
