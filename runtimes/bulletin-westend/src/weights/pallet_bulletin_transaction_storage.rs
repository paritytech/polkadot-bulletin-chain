...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_637_000, 0)
			...
			// Standard Error: 6
			.saturating_add(Weight::from_parts(6_172, 0).saturating_mul(l.into()))
	...
	fn store_with_cid_config(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_498_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 4
			.saturating_add(Weight::from_parts(5_977, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn remove_expired_account_authorization() -> Weight {
		...
		Weight::from_parts(20_504_000, 0)
			.saturating_add(Weight::from_parts(0, 3550))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn apply_block_inherents() -> Weight {
		...
		//  Measured:  `44334`
		//  Estimated: `47519`
		// Minimum execution time: 62_648_000 picoseconds.
		Weight::from_parts(65_771_000, 0)
	...
	fn on_initialize_with_expiry(n: u32, ) -> Weight {
		...
		Weight::from_parts(6_347_000, 0)
			...
			.saturating_add(Weight::from_parts(10_596_315, 0).saturating_mul(n.into()))
	...
	fn migrate_v2_to_v3_step() -> Weight {
		...
		//  Measured:  `41812`
		//  Estimated: `94048`
		// Minimum execution time: 136_894_000 picoseconds.
		Weight::from_parts(143_138_000, 0)
