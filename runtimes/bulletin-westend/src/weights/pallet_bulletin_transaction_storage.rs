...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_566_000, 0)
			...
			// Standard Error: 26
			.saturating_add(Weight::from_parts(6_886, 0).saturating_mul(l.into()))
	...
	fn store_with_cid_config(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_546_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 13
			.saturating_add(Weight::from_parts(6_427, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn refresh_preimage_authorization() -> Weight {
		...
		Weight::from_parts(14_181_000, 0)
			.saturating_add(Weight::from_parts(0, 3550))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn remove_expired_account_authorization() -> Weight {
		...
		Weight::from_parts(20_383_000, 0)
			.saturating_add(Weight::from_parts(0, 3550))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn validate_store(l: u32, ) -> Weight {
		...
		Weight::from_parts(20_146_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 14
			.saturating_add(Weight::from_parts(2_826, 0).saturating_mul(l.into()))
	...
	fn apply_block_inherents() -> Weight {
		...
		//  Measured:  `44334`
		//  Estimated: `47519`
		// Minimum execution time: 70_679_000 picoseconds.
	...
	fn on_initialize_with_expiry(n: u32, ) -> Weight {
		...
		Weight::from_parts(6_380_000, 0)
			...
			.saturating_add(Weight::from_parts(10_970_164, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(4))
	...
	fn migrate_v2_to_v3_step() -> Weight {
		...
		Weight::from_parts(146_813_000, 0)
