...
impl<T: frame_system::Config> pallet_bulletin_data_renewal::WeightInfo for WeightInfo<T> {
	...
	fn renew() -> Weight {
		...
		Weight::from_parts(35_727_000, 0)
	...
	fn enable_auto_renew() -> Weight {
		...
		//  Measured:  `416`
		//  Estimated: `47519`
		// Minimum execution time: 33_063_000 picoseconds.
		Weight::from_parts(36_026_000, 0)
			.saturating_add(Weight::from_parts(0, 47519))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn validate_renew() -> Weight {
		...
		Weight::from_parts(44_542_000, 0)
			.saturating_add(Weight::from_parts(0, 47519))
	...
	fn process_pending_renewals(n: u32, ) -> Weight {
		...
		Weight::from_parts(3_998_000, 0)
			...
			// Standard Error: 25_254
			.saturating_add(Weight::from_parts(15_588_901, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(3))
