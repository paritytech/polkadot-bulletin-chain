...
impl<T: frame_system::Config> pallet_bulletin_data_renewal::WeightInfo for WeightInfo<T> {
	...
	fn force_renew() -> Weight {
		...
		//  Measured:  `412`
		//  Estimated: `47519`
		// Minimum execution time: 28_616_000 picoseconds.
	...
	fn validate_renew() -> Weight {
		...
		//  Measured:  `537`
		//  Estimated: `47519`
		// Minimum execution time: 39_103_000 picoseconds.
		Weight::from_parts(41_075_000, 0)
			.saturating_add(Weight::from_parts(0, 47519))
	...
	fn process_pending_renewals(n: u32, ) -> Weight {
		...
		Weight::from_parts(4_155_000, 0)
			...
			.saturating_add(Weight::from_parts(14_454_447, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(3))
