...
impl<T: frame_system::Config> pallet_bulletin_hop_promotion::WeightInfo for WeightInfo<T> {
	...
	fn authorize_promote(d: u32, ) -> Weight {
		...
		Weight::from_parts(4_648_176, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 7
			.saturating_add(Weight::from_parts(1_386, 0).saturating_mul(d.into()))
	...
	fn authorize_promote_v2(d: u32, ) -> Weight {
		...
		//  Measured:  `444`
		//  Estimated: `45519`
		// Minimum execution time: 61_594_000 picoseconds.
		Weight::from_parts(12_060_304, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 7
			.saturating_add(Weight::from_parts(1_388, 0).saturating_mul(d.into()))
