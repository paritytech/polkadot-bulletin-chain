...
impl<T: frame_system::Config> pallet_bulletin_hop_promotion::WeightInfo for WeightInfo<T> {
	...
	fn authorize_promote(d: u32, ) -> Weight {
		...
		Weight::from_parts(58_446_000, 0)
			...
			// Standard Error: 5
			.saturating_add(Weight::from_parts(1_377, 0).saturating_mul(d.into()))
	...
	fn authorize_promote_v2(d: u32, ) -> Weight {
		...
		Weight::from_parts(61_932_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 4
			.saturating_add(Weight::from_parts(1_370, 0).saturating_mul(d.into()))
