...
impl<T: frame_system::Config> pallet_bulletin_hop_promotion::WeightInfo for WeightInfo<T> {
	...
	fn authorize_promote(d: u32, ) -> Weight {
		...
		Weight::from_parts(58_101_000, 0)
			...
			// Standard Error: 7
			.saturating_add(Weight::from_parts(1_420, 0).saturating_mul(d.into()))
	...
	fn authorize_promote_v2(d: u32, ) -> Weight {
		...
		//  Measured:  `444`
		//  Estimated: `45519`
		// Minimum execution time: 62_899_000 picoseconds.
		Weight::from_parts(63_263_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 6
			.saturating_add(Weight::from_parts(1_378, 0).saturating_mul(d.into()))
