...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage_renewal::WeightInfo for WeightInfo<T> {
	...
	fn renew() -> Weight {
		...
		Weight::from_parts(34_704_000, 0)
	...
	fn validate_renew() -> Weight {
		...
		//  Measured:  `533`
		//  Estimated: `47519`
		// Minimum execution time: 40_048_000 picoseconds.
	...
	fn process_pending_renewals(n: u32, ) -> Weight {
		...
		Weight::from_parts(4_017_000, 0)
			...
			// Standard Error: 20_116
			.saturating_add(Weight::from_parts(14_908_579, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(3))
