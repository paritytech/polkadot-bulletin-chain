...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_379_000, 0)
			...
			// Standard Error: 6
			.saturating_add(Weight::from_parts(6_124, 0).saturating_mul(l.into()))
	...
	fn store_with_cid_config(l: u32, ) -> Weight {
		...
		Weight::from_parts(15_851_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 3
			.saturating_add(Weight::from_parts(5_948, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn validate_store(l: u32, ) -> Weight {
		...
		Weight::from_parts(20_072_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 6
			.saturating_add(Weight::from_parts(2_684, 0).saturating_mul(l.into()))
	...
	fn apply_block_inherents() -> Weight {
		...
		//  Measured:  `44334`
		//  Estimated: `47519`
		// Minimum execution time: 63_126_000 picoseconds.
		Weight::from_parts(65_885_000, 0)
	...
	fn on_initialize_with_expiry(n: u32, ) -> Weight {
		...
		Weight::from_parts(6_395_000, 0)
			...
			.saturating_add(Weight::from_parts(10_586_754, 0).saturating_mul(n.into()))
	...
	fn migrate_v2_to_v3_step() -> Weight {
		...
		Weight::from_parts(143_889_000, 0)
