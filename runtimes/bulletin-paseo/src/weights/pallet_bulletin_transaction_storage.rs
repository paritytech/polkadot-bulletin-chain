...
//! HOSTNAME: `00ad6707816f`, CPU: `Intel(R) Xeon(R) CPU @ 2.60GHz`
...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_181_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 22
			.saturating_add(Weight::from_parts(7_442, 0).saturating_mul(l.into()))
	...
	fn store_with_cid_config(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_264_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 13
			.saturating_add(Weight::from_parts(7_121, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn add_authorizer() -> Weight {
		...
		Weight::from_parts(19_365_000, 0)
	...
	fn refresh_preimage_authorization() -> Weight {
		...
		Weight::from_parts(13_825_000, 0)
			.saturating_add(Weight::from_parts(0, 3550))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn validate_store(l: u32, ) -> Weight {
		...
		Weight::from_parts(19_960_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 23
			.saturating_add(Weight::from_parts(3_171, 0).saturating_mul(l.into()))
	...
	fn apply_block_inherents() -> Weight {
		...
		//  Measured:  `44334`
		//  Estimated: `47519`
		// Minimum execution time: 75_281_000 picoseconds.
		Weight::from_parts(84_739_000, 0)
	...
	fn on_initialize_with_expiry(n: u32, ) -> Weight {
		...
		Weight::from_parts(6_365_000, 0)
			...
			// Standard Error: 15_355
			.saturating_add(Weight::from_parts(11_639_578, 0).saturating_mul(n.into()))
