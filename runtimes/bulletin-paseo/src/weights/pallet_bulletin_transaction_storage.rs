...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store_with_cid_config(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_221_000, 0)
			.saturating_add(Weight::from_parts(0, 45519))
			// Standard Error: 13
			.saturating_add(Weight::from_parts(6_666, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	// Placeholder folded at the worst case `n = 512`; re-run benchmarks to refresh.
	fn apply_block_inherents() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `44334`
		//  Estimated: `47519`
		// Minimum execution time: 71_194_000 picoseconds.
		Weight::from_parts(80_661_033, 0)
