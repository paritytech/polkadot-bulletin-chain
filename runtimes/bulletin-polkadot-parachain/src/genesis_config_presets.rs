	...
	build_struct_json_patch!(RuntimeGenesisConfig {
		...
		transaction_storage: pallet_transaction_storage::GenesisConfig {
			account_authorizations: vec![
				...
				(account_id_from_seed("//Preimagesigner"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer1"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer2"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer3"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer4"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer5"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer6"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer7"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer8"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer9"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer10"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer11"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer12"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer13"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer14"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer15"), u32::MAX, u64::MAX),
				(account_id_from_seed("//Signer16"), u32::MAX, u64::MAX),
				(Sr25519Keyring::Alice.to_account_id(), u32::MAX, u64::MAX),
			],
		},
	})
}
